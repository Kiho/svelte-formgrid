(function () {
	...
	function create_each_block(component, ctx) {
		...
		function select_block_type(ctx) {
			if (typeof ctx.optionList[0] === 'string') return create_if_block;
	...
	function CheckboxInput(options) {
		...
		if (!document.getElementById("svelte-m11ft5-style")) add_css();
	...
	function Field(options) {
		...
		if (!document.getElementById("svelte-u293zm-style")) add_css$1();
	...
	function data$8() {
		return fieldBase.fieldData({ fieldtype: TextInput });
	}
	...
	function create_main_fragment$8(component, ctx) {
		...
		var field_initial_data = { settings: ctx.settings, fieldtype: ctx.fieldtype };
		if ('value' in ctx) {
	...
	/* src\NumberField.html generated by Svelte v2.4.2 */

	function data$9() {
		return fieldBase.fieldData({ fieldtype: NumberInput });
	}
	...
	assign(NumberField.prototype, proto);

	/* src\MaskedField.html generated by Svelte v2.4.2 */

	function data$10() {
		return fieldBase.fieldData({ fieldtype: MaskedInput });
	}
	...
	***************************************************************************** */
	...
	test('with no data, creates <TextInput /> elements', t => {
		...
		t.htmlEqual(target$2.innerHTML, `
	...
	test('detect invalid input with pattern', t => {
	    ...
	    let input = target$2.querySelector('input');
	...
	test('with no data, creates <input type="number" /> elements', t => {
		...
		t.htmlEqual(target$3.innerHTML, `
		<input type="number" class="form-control " placeholder="">
	`);

		const input = target$3.firstElementChild;
		t.equal(input.value, '1');
	...
	test('with no data, creates <SelectInput /> elements', t => {
		...
		t.htmlEqual(target$4.innerHTML, `
	...
	test('with no data, creates <input type="text" /> elements', t => {
		...
		t.htmlEqual(target$5.innerHTML, `
		<input type="text" class="form-control " placeholder="">
	`);	
		const input = target$5.firstElementChild;
